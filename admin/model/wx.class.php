...
class wx_controller extends adminCommon{  
	...
	function save_action(){
 		if($_POST["msgconfig"]){
			$this->logo_reset('sy_wx_qcode', $_POST['sy_wx_qcode']);
			$this->logo_reset('sy_wx_logo', $_POST['sy_wx_logo']);
			$this->logo_reset('sy_wx_sharelogo', $_POST['sy_wx_sharelogo']);

            $data['wx_welcom'] = $_POST['wx_welcom'];
            $data['wx_search'] = $_POST['wx_search'];
            $data['wx_rz'] = $_POST['wx_rz'];
            $data['wx_author'] = $_POST['wx_author'];
